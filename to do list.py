...
L1.place(x=90, y=10)
tasks = Listbox(root, selectbackground='white', bg='beige', font=('Helvetica', 12), height=12, width=25)
...
add_btn = Button(root, text='Add ', bg='Azure', width=10, font=('Helvetica', 12),command=lambda: add_item(new, tasks))
add_btn.place(x=45, y=350)
delete_btn = Button(root, text='Delete ', bg='Azure', width=10, font=('Helvetica', 12),command=lambda: delete_item(tasks))
